...
/*Good Heavens Stargazing */
  var contentString = 
    ...
    <div class="card-section-map">
      <div class="image1">
        <img src="../Level-2-Website-AS91893/Images/Map-Images/Good Heavens Stargazing.jpg" alt="Good Heavens" class="map-image">
      </div>
  ...
  var contentString1 = 
    ...
    <div class="card-section-map">
      <div class="image1">
        <img src="../Level-2-Website-AS91893/Images/Map-Images/great barrier island.jfif" alt="Great Barrier Island" class="map-image">
      </div>
  ...
  var infoWindowOptions1 = {
    ...
    maxHeight:10000,
     ...
     <div class="card-section-map">
       <div class="image1">
         <img src="../Level-2-Website-AS91893/Images/Map-Images/Dark Sky Project.jpg" alt="Dark Sky Project" class="map-image">
       </div>
   ...
   var infoWindowOptions2 = {
     ...
     <div class="card-section-map">
       <div class="image1">
         <img src="../Level-2-Website-AS91893/Images/Map-Images/Under the Stars.png" alt="Under the Stars" class="map-image">
       </div>
   ...
   var infoWindowOptions3 = {
     ...
     maxHeight:10000,
       ...
       <div class="card-section-map">
         <div class="image1">
           <img src="../Level-2-Website-AS91893/Images/Map-Images/Christchurch astroturf.png" alt="Christchurch AstroTurf" class="map-image">
         </div>
     ...
     var contentString5 = 
       ...
       <div class="card-section-map">
         <div class="image1">
           <img src="../Level-2-Website-AS91893/Images/Map-Images/Pukaki Wine Cellar.jpg" alt="Christchurch AstroTurf" class="map-image">
         </div>
     ...
     var infoWindowOptions5 = {
      ...
      <div class="card-section-map">
        <div class="image1">
          <img src="../Level-2-Website-AS91893/Images/Map-Images/Castepoint.jpg" alt="Castlepoint Scenic Drive" class="map-image">
        </div>
